...
#qsub -l procs=1,pmem=2000mb,walltime=12:00:00 -r n -N main_train_test_cv -o main_train_test_cv.out -e main_train_test_cv.err -M yifeng.li.cn@gmail.com -m bea main_mlp.py
import os
    ...
    for wid in wids:
        ...
        for i in range(kfolds):
            ...
            classifier,training_time=mlp.train_model(train_set_x_org=train_set_x_org, train_set_y_org=train_set_y_org, 
                                                     ...
                                                     activation_func="tanh", rng=rng, # activation_func can be "tanh", "sigmoid", or "relu"
                                                     max_num_epoch_change_learning_rate=80,max_num_epoch_change_rate=0.8,learning_rate_decay_rate=0.8) 
                        
            # test
            test_set_y_pred,test_set_y_pred_prob,test_time=mlp.test_model(classifier, test_set_x_org, batch_size=100)
