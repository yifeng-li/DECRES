...
#qsub -l procs=1,pmem=2000mb,walltime=12:00:00 -r n -N main_train_test_cv -o main_train_test_cv.out -e main_train_test_cv.err -M yifeng.li.cn@gmail.com -m bea main_ScA.py
import os
...
for cell in cells:
    for wid in wids:
        ...
        for i in range(kfolds):
            ...
            alpha_reg=0.5
            n_hidden=[256,128,64]
            contraction_levels=[0.01,0.01,0.01]
            ...
            # test the classifier
            test_set_y_pred,test_set_y_pred_prob,test_time=ScA.test_model(classifier, test_set_x_org, batch_size=200)
