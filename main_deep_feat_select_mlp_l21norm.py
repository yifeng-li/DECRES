...
"""
#qsub -l procs=1,pmem=2000mb,walltime=36:00:00 -r n -N main_DFS_feature_selection_l21norm -o main_DFS_feature_selection_l21norm.out -e main_DFS_feature_selection_l21norm.err -M yifeng.li.cn@gmail.com -m bea main_deep_feat_select_mlp_l21norm.py
import os
