...
"""
#qsub -l procs=1,pmem=2000mb,walltime=36:00:00 -r n -N main_DFS_feature_selection -o main_DFS_feature_selection.out -e main_DFS_feature_selection.err -M yifeng.li.cn@gmail.com -m bea main_deep_feat_select_ScA.py
import os
...
for cell in cells:
    for wid in wids:
        ...
        alpha2=0.0
        n_hidden=[256,64,16]
        contraction_levels=[0.05,0.05,0.05]
        ...
        for i in range(len(lambda1s)):
            ...
            classifier,training_time=deep_feat_select_ScA.train_model(train_set_x_org=train_set_x_org, train_set_y_org=train_set_y_org, 
                                                                      ...
                                                                      n_hidden=n_hidden, contraction_levels=contraction_levels,
            ...
            # test
            test_set_y_pred,test_set_y_pred_prob,test_time=deep_feat_select_ScA.test_model(classifier, test_set_x_org, batch_size=200)
