...
for cell in cells:
    for wid in wids:
        ...
        for i in range(kfolds):
            ...
            # train
            classifier,training_time=icnn.train_model(train_set_x_org=train_set_x_org, train_set_y_org=train_set_y_org,
                                          valid_set_x_org=valid_set_x_org, valid_set_y_org=valid_set_y_org, 
                                          n_row_each_sample=num_feat,pretrain_lr=pretrain_lr, finetune_lr=finetune_lr, alpha=alpha,
                                          pretraining_epochs=pretraining_epochs, training_epochs=training_epochs, rng=rng, 
                                          nkerns=nkerns,batch_size=batch_size, receptive_fields=receptive_fields,
                                          poolsizes=poolsizes,full_hidden_sub=full_hidden_sub,full_hidden_all=full_hidden_all,
