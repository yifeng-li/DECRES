...
"""
#qsub -l procs=1,pmem=2000mb,walltime=36:00:00 -r n -N main_DFS_feature_selection -o main_DFS_feature_selection.out -e main_DFS_feature_selection.err -M yifeng.li.cn@gmail.com -m bea main_deep_feat_select_mlp.py
import os
...
for cell in cells:
    for wid in wids:
        ...
        for i in range(len(lambda1s)):
            ...
            # test
            test_set_y_pred,test_set_y_pred_prob,test_time=deep_feat_select_mlp.test_model(classifier, test_set_x_org, batch_size=200)
