...
#qsub -l procs=1,pmem=2000mb,walltime=12:00:00 -r n -N main_train_test_cv -o main_train_test_cv.out -e main_train_test_cv.err -M yifeng.li.cn@gmail.com -m bea main_dA.py
import os
    ...
    for wid in wids:
        ...
        for i in range(kfolds):
            ...
            model_trained, train_set_x_extr, training_time = dA.train_model(train_set_x_org=train_set_x_org, 
                                                                            ...
                                                                            n_hidden=n_hidden, learning_rate=learning_rate, corruption_level=corruption_level, 
